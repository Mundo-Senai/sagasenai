...
<body class="bg-slate-500">
    ...
    <form action="../../php/controle/criar_curso.php" method="POST" id="enviar_formulario"  class="w-auto h-auto flex flex-col bg-blue-600/95 rounded-lg  m-auto
     text-gray-100 p-4 space-y-4">
        ...
        <div id="topo"> <h1 class="text-4xl font-semibold tracking-wide">Criar sala</h1></div>
            ...
            <input type="text" name="nome" id="curso" class="text-black 0 font-medium rounded-3xl py-1 text-2x1">

            <h3 class=" text-2xl tracking-wide">Capacidade</h3>

            <input type="number" name="nome" id="curso" class="text-black 0 font-medium rounded-3xl py-1 text-2x1">
